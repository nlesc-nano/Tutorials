...
.. download:`here  <https://github.com/nlesc-nano/Tutorials/tree/build_qd/docs/_files/3.olam.zip>`___. We will first of all need to rename the new files to match their molecular formulas (2 for each .pdb file, for a total of 6 new files in this example).
